...
DATA_SET_NAME = 'coyne_new_Pb_extracte_F_DCP1A_120825'
BATCH_TO_RUN = 'batch1'
...
OUTPUT_DIR = os.path.join(BASE_DIR,'cell_profiler', 'outputs', 'combined')
...
marker_dict = {'DAPI':[], 'G3BP1':[], 'KIF5A':[], 'PURA':[], 
            'NONO':[], 'TDP43':[], 'FMRP':[], 'SQSTM1':[], 'Phalloidin':[], 'PSD95':[], 'CLTC':[],

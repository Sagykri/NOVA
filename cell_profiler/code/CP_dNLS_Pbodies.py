...
# marker_targte       = ['LSM14A']  # list of markers to include; Empty list or None for all
# output_folder_name  = 'dNLS_Pb_FE_LSM14A_090925'
# pipeline_name       = 'BAR_170825_dNLS_PB_FE_LSM14A.cppipe'

input_folder_name   = 'OPERA_dNLS_6_batches_NOVA_sorted'
marker_targte       = ['DCP1A']  # list of markers to include; Empty list or None for all
output_folder_name  = 'dNLS_Pb_FE_DPC1A_120925'
pipeline_name       = 'BAR_310825_dNLS_PB_FE_DCP1A.cppipe'

# input_folder_name   = 'OPERA_dNLS_6_batches_NOVA_sorted'
# marker_targte       = ['TDP43']  # list of markers to include; Empty list or None for all
# output_folder_name  = 'dNLS_cyto_nuclear_TDP43_100925'
# pipeline_name       = 'Bar_040925_cyto-nuclear_TDP43.cppipe'
...
pipeline_path = os.path.join(
    BASE_DIR, 'cell_profiler', 'pipelines', 'FordNLS_new', pipeline_name
)

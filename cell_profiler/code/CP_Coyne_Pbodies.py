"""
Coyne patient-derived Pbody CellProfiler pipeline execution script.
Runs the CellProfiler pipeline for analyzing Pbody data.
"""
...
output_folder_name = 'coyne_old_DCP1A_030925_MAP2'
pipeline_name = 'TDP43_OLD.cppipe'
DATA_INPUT_DIR = os.path.join(
    BASE_DIR, 'input', 'images', 'raw', input_folder_name, 'MOmaps_iPSC_patients_TDP43_PB_CoyneLab'
)

# ----- Config - new -----
# input_folder_name = 'AlyssaCoyne_new_sorted' 
# output_folder_name = 'coyne_new_DCP1A_030925_MAP2'
# pipeline_name = 'TDP43_NEW.cppipe'
# DATA_INPUT_DIR = os.path.join(
#     BASE_DIR, 'input', 'images', 'raw', input_folder_name
# )

# ----- General Config -----
marker_targte = ['DCP1A']  # List of markers to process
pipeline_path = os.path.join(
    BASE_DIR, 'cell_profiler', 'pipelines', 'ForCoyneData', pipeline_name
)

...
# ----- Config -----
input_folder_name   = 'TDP43_WT_OE_PB_experiment_sorted'
marker_targte       = ['DCP1A']  # list of markers to include; Empty list or None for all
output_folder_name  = 'WT_OE_170925'
pipeline_name       = 'PB_feature_extraction_wt_OE_DCPA1.cppipe'

# input_folder_name   = 'TDP43_WT_OE_PB_experiment_sorted'
# marker_targte       = ['TDP43']  # list of markers to include; Empty list or None for all
# output_folder_name  = 'WT_OE_TDP43_170925'
# pipeline_name       = 'Bar_040925_cyto-nuclear_TDP43_OE.cppipe'
...
pipeline_path = os.path.join(
    BASE_DIR, 'cell_profiler', 'pipelines', 'For_OE', pipeline_name
)

# Paths to local directories
OUTPUT_DIR   = os.path.join(BASE_DIR, 'cell_profiler', 'outputs', 'cell_profiler_RUNS', "Final_cp_analysis",'PB_profiling',output_folder_name)
# OUTPUT_DIR   = os.path.join(BASE_DIR, 'cell_profiler', 'outputs', 'cell_profiler_RUNS', "Final_cp_analysis",'TDP_localization',output_folder_name)

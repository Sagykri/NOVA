...
from src.figures.effect_size_plotting import plot_barplot_alyssa_old
from src.datasets.dataset_config import DatasetConfig
from src.figures.plot_config import PlotConfig

from src.analysis.analyzer_effects_alyssa_OLD import AnalyzerEffectsAlyssaOLD
...
def plot_effect_sizes(output_folder_path:str, config_path_data:str, config_path_plot:str)->None:
    ...
    analyzer_effects = AnalyzerEffectsAlyssaOLD(config_data, output_folder_path)
    analyzer_effects.load()
    plot_output_folder_path = analyzer_effects.get_saving_folder(feature_type='effects')
    ...
    plot_barplot_alyssa_old(analyzer_effects.features, plot_output_folder_path, config_plot)

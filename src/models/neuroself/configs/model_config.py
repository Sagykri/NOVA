...
class TLNeuroselfB78ModelConfig(NeuroselfConfig):
    def __init__(self):
        ...
        self.MODEL_OUTPUT_FOLDER = '/home/labs/hornsteinlab/Collaboration/MOmaps_Sagy/MOmaps/outputs/models_outputs_batch78_tl_ep23/'
        self.LOGS_FOLDER = os.path.join(self.MODEL_OUTPUT_FOLDER, 'logs', "distances")
        self.CONFIGS_USED_FOLDER = os.path.join(self.MODEL_OUTPUT_FOLDER, "configs_used", "distances", datetime.datetime.now().strftime("%d%m%y_%H%M%S_%f"))

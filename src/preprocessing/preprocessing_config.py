...
class PreprocessingConfig(BaseConfig):
    def __init__(self):
        ...
        self.CELLPOSE = {
            'NUCLEUS_DIAMETER': 70, # old funova (gal) 70 # nova 60,
            'CELLPROB_THRESHOLD': 0.0,# old funova (gal) 0 # nova 0,
            'FLOW_THRESHOLD': 0.2 # old funova (gal) 0.22 # nova 0.4,
        }
        ...
        self.MAX_INTENSITY_UPPER_BOUND_THRESHOLD_TARGET:float = 1.1 #pilot2: 1.1# NEW THRESHOLD in pilot2 # None:1.1
        # After rescale intenisty - lower bound for variance
        self.VARIANCE_THRESHOLD_TARGET:float = -1.0 #pilot2:-1.0 #pilot1 : 0.001# old funova - 0.003 # none: 0 # NOVA: 0.0001 # None: -1.0
        # New threshold - upper bound for target's variance
        self.VARIANCE_UPPER_BOUND_THRESHOLD_TARGET:float = 0.14 #pilot2:  0.14#new threshold pilot2 # None: 1.1
        ...
        self.MIN_MEDIAN_INTENSITY_NUCLEI_BLOB_THRESHOLD:float = 0.55 #pilot2: 0.55 #pilot1: 0.63 #0.55  # old funova 0.4 #  none: 1.9 # NOVA: 0.95 
        # below "BOTTOM THRESHOLD"
        self.MAX_VARIANCE_NUCLEI_BLOB_THRESHOLD:float =  0.01 #pilot2: 0.01 #pilot1:0.01 #0.0065 # old funova 0.005 # None - 0.0
        # isn't used (pilot 1)
        # above "UPPER THRESHOLD"
        self.MIN_VARIANCE_NUCLEI_BLOB_THRESHOLD:float = 0.0355 #pilot2: 0.0355 #pilot1:0.0355 # old funova 0.025  # None - 0.0

...
from src.preprocessing.configs.preprocessor_opera_config import OperaPreprocessingConfig


class Opera_Batch1(OperaPreprocessingConfig):
    def __init__(self):
        super().__init__()
        ...
        self.LOGS_FOLDER = os.path.join(self.OUTPUTS_SUBSUBFOLDER, 'logs', "preprocessing_Opera", 'batch1')

...
class Opera18DaysReimagedPreprocessingBaseConfig(PreprocessingConfig):
    def __init__(self):
        ...
        self.MARKERS_FOCUS_BOUNDRIES_PATH =  os.path.join(os.getenv("MOMAPS_HOME"), 'src', 'preprocessing', 'markers_focus_boundries', 'markers_focus_boundries_opera18days.csv')

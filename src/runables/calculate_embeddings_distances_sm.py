...
from src.common.lib.embeddings_distances_utils import calc_embeddings_distances_for_SM, unite_batches
from src.common.lib.utils import load_config_file, get_if_exists
import logging


def run_calc_embeddings_distances_for_SM(config_path_model, config_path_data, embeddings_type):
    ...
    calc_embeddings_distances_for_SM(config_model,config_data, distances_main_folder, embeddings_type)
...
if __name__ == "__main__":
    ...
    try:
        run_calc_embeddings_distances_for_SM(config_path_model= sys.argv[1], config_path_data=sys.argv[2], embeddings_type=sys.argv[3])

...
class PreprocessingBaseConfigRANBP17ExpBatch3(PreprocessingBaseConfigRANBP17Exp):
    def __init__(self):
        ...
        self.CONDITIONS = ["tardp-kd", "ranbp17-kd", "control-179", "control-180", "both-kd", "untreated"]
        self.REPS = ["rep1","rep2"] # partial:["rep1","rep2"]
        self.PANELS = ["panelA", "panelB"]
        self.MARKERS = ['DAPI', 'TDP-43', 'RANBP17']
...
class PreprocessingBaseConfigRANBP17ExpBatch3PanelA(PreprocessingBaseConfigRANBP17Exp):
    def __init__(self):
        super().__init__()
        ...
        self.CONDITIONS = ["tardp-kd", "ranbp17-kd", "control-179", "control-180", "both-kd", "untreated"]
        self.REPS = ["rep1","rep2","rep4", "rep5", "rep6", "rep7", "rep8"] # full: removing rep3: technical probelm: no DAPI staining, very noisy 
        self.PANELS = ["panelA"]
        self.MARKERS = ['DAPI', 'TDP-43', 'RANBP17']
...
class PreprocessingBaseConfigRANBP17ExpBatch3PanelB(PreprocessingBaseConfigRANBP17Exp):
    def __init__(self):
        super().__init__()
        ...
        self.CONDITIONS = ["tardp-kd", "ranbp17-kd", "control-179", "control-180", "both-kd", "untreated"]
        self.REPS = ["rep1","rep2","rep3"] # full: removing rep3: technical probelm: no DAPI staining, very noisy 
        self.PANELS = ["panelB"]
        self.MARKERS = ['DAPI', 'SG', 'RANBP17_SG']

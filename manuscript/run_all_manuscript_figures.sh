...
# # Figure 1
# # #######################
$MOMAPS_HOME/runnables/run.py $MOMAPS_HOME/runnables/generate_umaps_and_plot -m 10000 \
...
# # Figure 2
# # #######################
# $MOMAPS_HOME/runnables/run.py $MOMAPS_HOME/runnables/generate_umaps_and_plot -m 5000 \
...
# $MOMAPS_HOME/runnables/run.py $MOMAPS_HOME/runnables/plot_distances_boxplots -m 5000 \
...
# $MOMAPS_HOME/runnables/run.py $MOMAPS_HOME/runnables/generate_umaps_and_plot -m 1000 \
...
# $MOMAPS_HOME/runnables/run.py $MOMAPS_HOME/runnables/plot_distances_boxplots -m 1000 \
...
# $MOMAPS_HOME/runnables/run.py $MOMAPS_HOME/runnables/plot_distances_bubble -m 1000 \

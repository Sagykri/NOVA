...
##### tmp checking an alternative for the umap0 pairs ######
# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 \
...
# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/plot_distances_bubble -m 1000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneDistancesFigureConfig $plot_configs/DistancesAlyssaCoynePlotConfig -j alyssa_dist

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP0FigureConfig $plot_configs/UMAP0AlyssaCoyneColorByGroupPlotConfig -j umap0_alyssa

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP0FigureConfig $plot_configs/UMAP0AlyssaCoyneColorByPatientPlotConfig -j umap0_alyssa

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 10000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP2FigureConfig $plot_configs/UMAP2AlyssaCoyneColorByGroupPlotConfig -j umap2_alyssa

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 10000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP2FigureConfig $plot_configs/UMAP2AlyssaCoyneColorByPatientColorControlsPlotConfig -j umap2_alyssa

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 10000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP2FigureConfig $plot_configs/UMAP2AlyssaCoyneColorByPatientColorsALSPositivePlotConfig -j umap2_alyssa

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 10000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP2FigureConfig $plot_configs/UMAP2AlyssaCoyneColorByPatientColorsALSNegativePlotConfig -j umap2_alyssa

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 10000 -g \
# -a $finetune_model $data_configs/AlyssaCoyneUMAP2FigureConfig $plot_configs/UMAP2AlyssaCoyneColorByPatientColorC9PlotConfig -j umap2_alyssa
...
# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_FUSHomozygous_B9FigureConfig $plot_configs/UMAP0ALSPlotConfig -j umap0_als_fushomo

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_FUSHeterozygous_B9FigureConfig $plot_configs/UMAP0ALSPlotConfig -j umap0_als_fushetero

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_FUSRevertant_B9FigureConfig $plot_configs/UMAP0ALSPlotConfig  -j umap0_als_fusrev

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_TBK1_B9FigureConfig $plot_configs/UMAP0ALSPlotConfig  -j umap0_als_tbk1

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_OPTN_B9FigureConfig $plot_configs/UMAP0ALSPlotConfig  -j umap0_als_optn

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_TDP43_B9FigureConfig $plot_configs/UMAP0ALSPlotConfig -j umap0_als_tdp43
...
# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_FUSHomozygous_B69FigureConfig $plot_configs/UMAP0ALSPlotConfig -j umap0_als_fushomo_69

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_FUSHeterozygous_B69FigureConfig $plot_configs/UMAP0ALSPlotConfig -j umap0_als_fushetero_69

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_FUSRevertant_B69FigureConfig $plot_configs/UMAP0ALSPlotConfig  -j umap0_als_fusrev_69

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_TBK1_B69FigureConfig $plot_configs/UMAP0ALSPlotConfig  -j umap0_als_tbk1_69

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_OPTN_B69FigureConfig $plot_configs/UMAP0ALSPlotConfig  -j umap0_als_optn_69

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_umaps_and_plot -m 5000 -g \
# -a $finetune_model $data_configs/NeuronsUMAP0ALS_TDP43_B69FigureConfig $plot_configs/UMAP0ALSPlotConfig -j umap0_als_tdp43_69

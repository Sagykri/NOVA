...
class Opera18DaysReimagedPreprocessingBaseConfig(PreprocessingConfig):
    def __init__(self):
        ...
        self.MARKERS_FOCUS_BOUNDRIES_PATH =  os.path.join(os.getenv("MOMAPS_HOME"), 'manuscript', 'markers_focus_boundries', 'markers_focus_boundries_opera18days_reimaged.csv')

class d18_Batch1(Opera18DaysReimagedPreprocessingBaseConfig):
    def __init__(self):
        super().__init__()

...
class AAT_NOVA_BaseFigureConfig(PlotConfig):
    def __init__(self):
        ...
        self.COLOR_MAPPINGS_AAT_NOVA_BATCHES = {
            ...
            'batch3': {self.MAPPINGS_ALIAS_KEY: 'Batch3', self.MAPPINGS_COLOR_KEY: "#D62525"},
        }

        # Markers
        self.COLOR_MAPPINGS_AAT_NOVA = {
            'DAPI': {self.MAPPINGS_ALIAS_KEY: 'Nucleus', self.MAPPINGS_COLOR_KEY: "#7181C7"},
            'ATF4': {self.MAPPINGS_ALIAS_KEY: 'ATF4', self.MAPPINGS_COLOR_KEY: "#3030AC"},
            ...
            'POM121': {self.MAPPINGS_ALIAS_KEY: 'POM121', self.MAPPINGS_COLOR_KEY: "#043121"},
        ...
        self.COLOR_MAPPINGS_AAT_NOVA_MARKER_PER_CONDITIONS = {
            ...
            'ATF4_Untreated': {self.MAPPINGS_ALIAS_KEY: 'ATF4_Untreated', self.MAPPINGS_COLOR_KEY: '#000000'},
            ...
            'G3BP1_Untreated': {self.MAPPINGS_ALIAS_KEY: 'G3BP1_Untreated', self.MAPPINGS_COLOR_KEY: '#000000'},
            ...
            'POM121_Untreated': {self.MAPPINGS_ALIAS_KEY: 'POM121_Untreated', self.MAPPINGS_COLOR_KEY: '#000000'},
            ...
            'ATF4_PPP2R1A': {self.MAPPINGS_ALIAS_KEY: 'ATF4_PPP2R1A', self.MAPPINGS_COLOR_KEY: '#4343FE'},
            ...
            'G3BP1_PPP2R1A': {self.MAPPINGS_ALIAS_KEY: 'G3BP1_PPP2R1A', self.MAPPINGS_COLOR_KEY: '#F04521'},
            ...
            'POM121_PPP2R1A': {self.MAPPINGS_ALIAS_KEY: 'POM121_PPP2R1A', self.MAPPINGS_COLOR_KEY: '#DEDB23'},
        ...
        self.COLOR_MAPPINGS_AAT_NOVA_CATEGORIES = {
            ...
            'POM121': {self.MAPPINGS_ALIAS_KEY: 'Proteostasis', self.MAPPINGS_COLOR_KEY: '#1F77B4'},
            ...
            # Splicing ( red)
            'G3BP1': {self.MAPPINGS_ALIAS_KEY: 'Splicing', self.MAPPINGS_COLOR_KEY: '#E41A1C'},
            'UNC13A': {self.MAPPINGS_ALIAS_KEY: 'Splicing', self.MAPPINGS_COLOR_KEY: '#E41A1C'},

            #Cell Death (green)
            'ATF4': {self.MAPPINGS_ALIAS_KEY: 'Cell Death', self.MAPPINGS_COLOR_KEY: '#4DAF4A'},
...
class UMAP1AAT_NOVAPlotConfig(AAT_NOVA_BaseFigureConfig):
    def __init__(self):
        ...
        self.ORDERED_MARKER_NAMES = ["DAPI", "ATF4", "FK-2", "SMI32", "pDRP1", "TOMM20", "pCaMKIIa", "pTDP-43", "TDP-43", "ATF6", "pAMPK", "G3BP1", "pS6", "PAR", "UNC13A", "Calreticulin", "POM121", "p62", "CathepsinD"]

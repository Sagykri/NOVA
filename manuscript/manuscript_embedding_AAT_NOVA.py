...
# -----------------------------------------------------------------------------------
# Pilot 2 
class EmbeddingsAATNOVAPilot2DatasetConfig(EmbeddingsConfig):
    def __init__(self):
        super().__init__()
        ...
        self.CELL_LINES:List[str]  = ["CTL", "C9"]
        self.CONDITIONS:List[str]  = ["PPP2R1A","HMGCS1","PIK3C3","NDUFAB1","MAPKAP1","NDUFS2","RALA","TLK1","NRIP1","TARDBP","RANBP17","CYLD","NT-1873","NT-6301-3085","Intergenic","Untreated"]
        self.MARKERS:List[str]  = ["DAPI", "ATF4", "FK-2", "SMI32", "pDRP1", "TOMM20", "pCaMKIIa", "pTDP-43", "TDP-43", "ATF6", "pAMPK", "G3BP1", "pS6", "PAR", "UNC13A", "Calreticulin", "POM121", "p62", "CathepsinD", "Brightfield"]

class EmbeddingsAATNOVAPilot2AllBatchesDatasetConfig(EmbeddingsAATNOVAPilot2DatasetConfig):
    def __init__(self):
        super().__init__()
...
class EmbeddingsAATNOVAPilot2B1DatasetConfig(EmbeddingsAATNOVAPilot2DatasetConfig):
    def __init__(self):
        super().__init__()
...
class EmbeddingsAATNOVAPilot2B2DatasetConfig(EmbeddingsAATNOVAPilot2DatasetConfig):
    def __init__(self):
        super().__init__()
...
class EmbeddingsAATNOVAPilot2B3DatasetConfig(EmbeddingsAATNOVAPilot2DatasetConfig):
    def __init__(self):
        super().__init__()

"""Spec-driven config generation for RANBP17_exp UMAPs.
...
GENERATED_DATA_FILE = _HERE / "manuscript_figures_data_config_RANBP17_exp_generated.py"
GENERATED_PLOT_FILE = _HERE / "manuscript_plot_config_RANBP17_exp_generated.py"
...
# location.
DATA_MODULE_PATH = "./NOVA/manuscript/manuscript_figures_data_config_RANBP17_exp_generated"
PLOT_MODULE_PATH = "./NOVA/manuscript/manuscript_plot_config_RANBP17_exp_generated"
...
def _gen_data_class(spec):
    name = "RANBP17_exp_Data_" + _safe(spec.get("name", "unnamed"))
    lines = [f"class {name}(RANBP17_exp_BaseFigureConfig):",
             "    def __init__(self):",
             "        super().__init__()"]
    body_lines = []
...
def _gen_plot_class(spec, data=None):
    ...
    name = "RANBP17_exp_Plot_" + _safe(spec.get("name", "unnamed")) + f"_{color_by}"

    lines = [f"class {name}(RANBP17_exp_BasePlotConfig):",
             "    def __init__(self):",
             "        super().__init__()",
    ...
    lines.append("        self.COLOR_MAPPINGS_MARKERS = self.COLOR_MAPPINGS_RANBP17_EXP_MARKERS")
...
_DATA_HEADER = '''"""AUTO-GENERATED by ranbp17_exp_run_helpers.submit_runs(). Do not edit by hand."""
import os, sys
...
_PLOT_HEADER = '''"""AUTO-GENERATED by ranbp17_exp_run_helpers.submit_runs(). Do not edit by hand."""
import os, sys
sys.path.insert(1, os.getenv("NOVA_HOME"))

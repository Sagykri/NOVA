...
# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_distances -g \
# -a $output_folder $distances_configs/NeuronsDistance345Config -j dist_neurons_345

# $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/generate_distances -g \
# -a $output_folder $distances_configs/NeuronsDistanceWith345Config -j dist_neurons_with_345

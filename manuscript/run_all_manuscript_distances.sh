...
for model_path in "${models_path[@]}"; do
    ...
    # $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/calculate_distances -g -m 20000 -b 10 \
    # -a $model_path $data_configs/newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_RepEffect_B1 rep_effect -q short-gpu -j dis_nD8_WT_vs_FUSLines_FUSMarker_repEffect_B1

    # $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/calculate_distances -g -m 20000 -b 10 \
    # -a $model_path $data_configs/newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_RepEffect_B2 rep_effect -q short-gpu -j dis_nD8_WT_vs_FUSLines_FUSMarker_repEffect_B2

    # $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/calculate_distances -g -m 20000 -b 10 \
    # -a $model_path $data_configs/newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_RepEffect_B3 rep_effect -q short-gpu -j dis_nD8_WT_vs_FUSLines_FUSMarker_repEffect_B3

    # $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/calculate_distances -g -m 20000 -b 10 \
    # -a $model_path $data_configs/newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_RepEffect_B7 rep_effect -q short-gpu -j dis_nD8_WT_vs_FUSLines_FUSMarker_repEffect_B7

    # $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/calculate_distances -g -m 20000 -b 10 \
    # -a $model_path $data_configs/newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_RepEffect_B8 rep_effect -q short-gpu -j dis_nD8_WT_vs_FUSLines_FUSMarker_repEffect_B8

    # $NOVA_HOME/runnables/run.sh $NOVA_HOME/runnables/calculate_distances -g -m 20000 -b 10 \
    # -a $model_path $data_configs/newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_RepEffect_B9 rep_effect -q short-gpu -j dis_nD8_WT_vs_FUSLines_FUSMarker_repEffect_B9

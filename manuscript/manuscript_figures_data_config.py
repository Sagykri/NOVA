...
class NeuronsUMAP0StressB3FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP0StressB4FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP0StressB5FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsDistancesStress345FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
        self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "spd2", "SpinningDisk", f) for f in 
...
class NeuronsDistancesStressWith345FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
        self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "spd2", "SpinningDisk", f) for f in 
...
class NeuronsUMAP2StressB3FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP2StressB4FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP2StressB5FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP2ALSB3FigureConfig(NeuronsUMAP2ALSFigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP2ALSB4FigureConfig(NeuronsUMAP2ALSFigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsUMAP2ALSB5FigureConfig(NeuronsUMAP2ALSFigureConfig):
    def __init__(self):
        super().__init__()
...
class NeuronsDistancesALS345FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
        self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "spd2", "SpinningDisk", f) for f in 
                        [f"batch{i}" for i in range(3,6)]]
...
class NeuronsDistancesALSWith345FigureConfig(FigureConfig):
    def __init__(self):
        super().__init__()
        self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "spd2", "SpinningDisk", f) for f in 
                        [f"batch{i}" for i in range(3,10)]]

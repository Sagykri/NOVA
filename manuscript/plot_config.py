...
class PlotConfig(PlotConfig):
    ...
    def __init__(self):
        ...
        self.COLOR_MAPPINGS_ALYSSA: Dict[str, Dict[str,str]] = {
            ...
            'Controls_rep1':{self.MAPPINGS_ALIAS_KEY: 'Control (1)',self.MAPPINGS_COLOR_KEY: '#58cfdf'},
            'Controls_rep2':{self.MAPPINGS_ALIAS_KEY: 'Control (2)',self.MAPPINGS_COLOR_KEY: '#4db6c4'},
            'Controls_rep3':{self.MAPPINGS_ALIAS_KEY: 'Control (3)',self.MAPPINGS_COLOR_KEY: '#439da9'},
            'Controls_rep4':{self.MAPPINGS_ALIAS_KEY: 'Control (4)',self.MAPPINGS_COLOR_KEY: '#38848f'},
            'Controls_rep5':{self.MAPPINGS_ALIAS_KEY: 'Control (5)',self.MAPPINGS_COLOR_KEY: '#2e6c74'},
            'Controls_rep6':{self.MAPPINGS_ALIAS_KEY: 'Control (6)',self.MAPPINGS_COLOR_KEY: '#235359'},
            
            'sALSPositiveCytoTDP43_rep1':{self.MAPPINGS_ALIAS_KEY:'sALS+ (1)', self.MAPPINGS_COLOR_KEY:'#f6ce55'},
            'sALSPositiveCytoTDP43_rep10':{self.MAPPINGS_ALIAS_KEY:'sALS+ (10)', self.MAPPINGS_COLOR_KEY:'#e8c350'},
            'sALSPositiveCytoTDP43_rep2':{self.MAPPINGS_ALIAS_KEY:'sALS+ (2)', self.MAPPINGS_COLOR_KEY:'#dbb74c'},
            'sALSPositiveCytoTDP43_rep3':{self.MAPPINGS_ALIAS_KEY:'sALS+ (3)', self.MAPPINGS_COLOR_KEY:'#cdac47'},
            'sALSPositiveCytoTDP43_rep4':{self.MAPPINGS_ALIAS_KEY:'sALS+ (4)', self.MAPPINGS_COLOR_KEY:'#bfa042'},
            'sALSPositiveCytoTDP43_rep5':{self.MAPPINGS_ALIAS_KEY:'sALS+ (5)', self.MAPPINGS_COLOR_KEY:'#b2953d'},
            'sALSPositiveCytoTDP43_rep6':{self.MAPPINGS_ALIAS_KEY:'sALS+ (6)', self.MAPPINGS_COLOR_KEY:'#a48939'},
            'sALSPositiveCytoTDP43_rep7':{self.MAPPINGS_ALIAS_KEY:'sALS+ (7)', self.MAPPINGS_COLOR_KEY:'#967e34'},
            'sALSPositiveCytoTDP43_rep8':{self.MAPPINGS_ALIAS_KEY:'sALS+ (8)', self.MAPPINGS_COLOR_KEY:'#89722f'},
            'sALSPositiveCytoTDP43_rep9':{self.MAPPINGS_ALIAS_KEY:'sALS+ (9)', self.MAPPINGS_COLOR_KEY:'#7b672a'},

            'sALSNegativeCytoTDP43_rep1':{self.MAPPINGS_ALIAS_KEY:'sALS- (1)', self.MAPPINGS_COLOR_KEY:'#3ce23c'},
            'sALSNegativeCytoTDP43_rep2':{self.MAPPINGS_ALIAS_KEY:'sALS- (2)', self.MAPPINGS_COLOR_KEY:'#1e711e'},

            'c9orf72ALSPatients_rep1':{self.MAPPINGS_ALIAS_KEY:'C9 (1)', self.MAPPINGS_COLOR_KEY:'#eb3440'},
            'c9orf72ALSPatients_rep2':{self.MAPPINGS_ALIAS_KEY:'C9 (2)', self.MAPPINGS_COLOR_KEY:'#bc2a33'},
            'c9orf72ALSPatients_rep3':{self.MAPPINGS_ALIAS_KEY:'C9 (3)', self.MAPPINGS_COLOR_KEY:'#8d1f26'},

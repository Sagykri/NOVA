...
class PlotConfig(plot_config.PlotConfig):
    ...
    def __init__(self):
        ...
        self.COLOR_MAPPINGS_MARKERS: Dict[str, Dict[str,str]] = {
            ...
            'FUS':{self.UMAP_MAPPINGS_ALIAS_KEY:'hnRNP complex', self.UMAP_MAPPINGS_COLOR_KEY:'#12F986'},
            'NCL':{self.UMAP_MAPPINGS_ALIAS_KEY:'Nucleolus', self.UMAP_MAPPINGS_COLOR_KEY:'#66CDAA'},
            'TDP43':{self.UMAP_MAPPINGS_ALIAS_KEY:'TDP-43 granules', self.UMAP_MAPPINGS_COLOR_KEY:'#18E4CF'},
            'TDP43B':{self.UMAP_MAPPINGS_ALIAS_KEY: 'TDP-43 granules', self.UMAP_MAPPINGS_COLOR_KEY :'#18E4CF'},
            'NONO':{self.UMAP_MAPPINGS_ALIAS_KEY:'Paraspeckles', self.UMAP_MAPPINGS_COLOR_KEY:'#06A0E9'},
            'ANXA11':{self.UMAP_MAPPINGS_ALIAS_KEY:'ANXA11 granules', self.UMAP_MAPPINGS_COLOR_KEY:'#168FB2'},
            'GM130':{self.UMAP_MAPPINGS_ALIAS_KEY:'Golgi', self.UMAP_MAPPINGS_COLOR_KEY:'#37378D'},
            'LAMP1':{self.UMAP_MAPPINGS_ALIAS_KEY:'Lysosome', self.UMAP_MAPPINGS_COLOR_KEY:'#4343FE'},
            'PEX14':{self.UMAP_MAPPINGS_ALIAS_KEY:'Peroxisome', self.UMAP_MAPPINGS_COLOR_KEY:'#D257EA'},
            'Calreticulin':{self.UMAP_MAPPINGS_ALIAS_KEY:'ER', self.UMAP_MAPPINGS_COLOR_KEY:'#9968CB'},
            'DCP1A':{self.UMAP_MAPPINGS_ALIAS_KEY:'P-Bodies', self.UMAP_MAPPINGS_COLOR_KEY:'#E6A9EA'},
            'CD41':{self.UMAP_MAPPINGS_ALIAS_KEY:'Integrin puncta', self.UMAP_MAPPINGS_COLOR_KEY:'#F1CBDD'},
            'SQSTM1':{self.UMAP_MAPPINGS_ALIAS_KEY:'Autophagosomes', self.UMAP_MAPPINGS_COLOR_KEY:'#F0A3A3'},
            'PML':{self.UMAP_MAPPINGS_ALIAS_KEY:'PML bodies', self.UMAP_MAPPINGS_COLOR_KEY:'#EF218B'},
            'SCNA':{self.UMAP_MAPPINGS_ALIAS_KEY:'Presynapse', self.UMAP_MAPPINGS_COLOR_KEY:'#F04521'},
            'SNCA':{self.UMAP_MAPPINGS_ALIAS_KEY: 'Presynapse', self.UMAP_MAPPINGS_COLOR_KEY : '#F04521'},
            'NEMO':{self.UMAP_MAPPINGS_ALIAS_KEY:'NEMO granules', self.UMAP_MAPPINGS_COLOR_KEY:'#F08F21'},
            'PSD95':{self.UMAP_MAPPINGS_ALIAS_KEY:'Postsynapse', self.UMAP_MAPPINGS_COLOR_KEY:'#FFBF0D'},
            'KIF5A':{self.UMAP_MAPPINGS_ALIAS_KEY:'Transport machinery', self.UMAP_MAPPINGS_COLOR_KEY:'#DEDB23'},
            'CLTC':{self.UMAP_MAPPINGS_ALIAS_KEY:'Coated vesicles', self.UMAP_MAPPINGS_COLOR_KEY:'#ACE142'},
            'TOMM20':{self.UMAP_MAPPINGS_ALIAS_KEY:'MOM', self.UMAP_MAPPINGS_COLOR_KEY:'#898700'},
            'mitotracker':{self.UMAP_MAPPINGS_ALIAS_KEY:'Mitochondria', self.UMAP_MAPPINGS_COLOR_KEY:'#32AC0E'},
            ...
            'FMRP':{self.UMAP_MAPPINGS_ALIAS_KEY:'RNA granules', self.UMAP_MAPPINGS_COLOR_KEY:'gray'},

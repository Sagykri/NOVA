...
class Opera18DaysReimagedPreprocessingBaseConfig(PreprocessingConfig):
    def __init__(self):
        ...
        self.PROCESSED_FOLDER_ROOT = os.path.join(self.PROCESSED_FOLDER_ROOT, "Opera18DaysReimaged80pct")
        self.OUTPUTS_FOLDER = os.path.join(self.OUTPUTS_FOLDER, "Opera18Days_Reimaged80pct")
...
class NeuronsD18_Batch1(Opera18DaysReimagedPreprocessingBaseConfig):
    def __init__(self):
        ...
        self.OUTPUTS_FOLDER = os.path.join(self.OUTPUTS_FOLDER, "batch180")

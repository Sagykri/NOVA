...
config = {
        ...
        'batch_size_per_gpu': 300,#300,#3,#65,
        'num_workers': 6,
        ...
        "output_dir": f"/home/labs/hornsteinlab/Collaboration/MOmaps_Sagy/MOmaps/sandbox/eval_new_arch/vit/checkpoints_{now_formatted}_{jobid}"
    }

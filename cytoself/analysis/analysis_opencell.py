...
class AnalysisOpenCell(BaseAnalysis):
    ...
    def compute_umap(
        ...
        **kwargs,
        ...
        if embedding_data is None:
            logging.info('Computing embeddings from image...')
            ...
            if savepath_embeddings is not None:
                ...
                logging.info(f'embeddings {fname} have been saved at {savepath_embeddings}')

        logging.info('Computing UMAP coordinates from embeddings...')
    ...
    def calculate_cellid_ondim0_vqidx_ondim1(
        ...
        logging.info('Computing cell line ID vs vq index...')
    ...
    def calculate_corr_vqidx_vqidx(
        ...
        """
        logging.info('Computing self Pearson correlation...')
    ...
    def plot_clustermap(
        ...
        logging.info('computing clustermaps...')

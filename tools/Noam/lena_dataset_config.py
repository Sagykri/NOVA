...
class LenaDatasetConfig(DatasetConfig):
    def __init__(self):
        ...
        #self.MARKERS = ['NCL', 'NEMO', 'NONO', 'PEX14', 'Phalloidin', 'PML', 'PSD95', 'PURA', 'SCNA', 'SQSTM1', 'TDP43', 'TIA1', 'TOMM20']
        #['G3BP1', 'PURA', 'FMRP']#, 'Calreticulin', 'SQSTM1']#, 'NCL', 'TDP43', 'mitotracker', 'FMRP'] #['FUS']
        self.CONDITIONS = ['Untreated']
        
        # You can add more folder like this: input_folders_names = ["batch9_16bit", "batch7", "batch6",] 
        input_folders_names = ['Perturbations_16bit_no_downsample']#, 'batch9_16bit_no_downsample', 'batch4_16bit_no_downsample']
        #self.EMBEDDINGS_LAYER = 'vqvec1'
        #self.MARKERS = ['ANXA11', 'Calreticulin', 'CD41', 'CLTC', 'DAPI', 'DCP1A']

        # running
        #
        # ['FMRP', 'FUS', 'G3BP1', 'GM130', 'KIF5A', 'LAMP1', 'mitotracker', 'NCL', 'NEMO'] ['TIA1', 'TOMM20']
        #['NONO', 'PEX14', 'Phalloidin', 'PML', 'PSD95', 'PURA', 'SCNA', 'SQSTM1', 'TDP43']

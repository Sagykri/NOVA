...
echo "Running script"
$MOMAPS_HOME/bash_commands/run_py.sh $MOMAPS_HOME/src/runables/generate_umaps -g -m 40000 -b 10 -a ./tools/Noam/lena_model_config/NeuroselfLenaConfig ./tools/Noam/lena_dataset_config/LenaDatasetConfig /home/labs/hornsteinlab/Collaboration/MOmaps/tools/Noam -q gpu-short

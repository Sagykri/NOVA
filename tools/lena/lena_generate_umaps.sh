...
echo "Running script"
$MOMAPS_HOME/bash_commands/run_py.sh $MOMAPS_HOME/src/runables/generate_umaps -g -m 7000 -b 10 -a ./lena/lena_model_config/NeuroselfLenaConfig ./lena/lena_dataset_config/LenaDatasetConfig -q gpu-short

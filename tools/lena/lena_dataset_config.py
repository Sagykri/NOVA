...
class LenaDatasetConfig(DatasetConfig):
    def __init__(self):
        ...
        #self.CELL_LINES = ['WT', 'TDP43', 'TBK1', 'FUSHomozygous', 'OPTN']# ['WT', 'TDP43', 'TBK1', 'FUSHomozygous', 'FUSHeterozygous', 'FUSRevertant', 'SCNA', 'OPTN', ]
        self.CELL_LINES = ['WT', 'FUSHomozygous', 'FUSRevertant']# ['WT', 'TDP43', 'TBK1', 'FUSHomozygous', 'FUSHeterozygous', 'FUSRevertant', 'SCNA', 'OPTN', ]
        ...
        #                 'TOMM20'
        #                 ]
        self.MARKERS_TO_EXCLUDE = ["DAPI", "TIA1", "FMRP", "FUS"]#, , "KIF5A", 'FUS']#, "TIA1", "FMRP", "SCNA", 'LAMP1', 'SQSTM1']
        ...
        self.EMBEDDINGS_LAYER = 'vqindhist2'# vqindhist2, 'vqvec2' # 'vqvec1' / 'vqvec2' / 'vqvec_both'
        # running
        #

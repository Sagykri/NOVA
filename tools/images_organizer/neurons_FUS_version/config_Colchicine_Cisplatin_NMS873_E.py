...
class Config_CCN_E(Config):
    def __init__(self):
        super().__init__()
        

        self.FOLDERS = ['20240204_Colchicine_Cisplatin_NMS873_2d1d_D-F']
        self.EXCLUDE_SUB_FOLDERS = ["20240204_Colchicine_Cisplatin_NMS873_2d1d_D-F/PanelD", "20240204_Colchicine_Cisplatin_NMS873_2d1d_D-F/PanelF"]

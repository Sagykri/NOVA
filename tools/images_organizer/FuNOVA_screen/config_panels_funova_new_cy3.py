...
class Config_A(Config_Base_4Markers):
    def __init__(self, batch, plate):
        ...
        self.col_rep2 = 2
        self.panel = 'A'
        self.markers = ["TDP-43_new_cy3","DAPI_new_cy3"]
...
class Config_B(Config_Base_4Markers):
    def __init__(self, batch, plate):
        ...
        self.col_rep2 = 4
        self.panel = 'B'
        self.markers = ["pTDP-43_new_cy3", "DAPI_new_cy3"]
...
class Config_C(Config_Base_4Markers):
    def __init__(self, batch, plate):
        ...
        self.col_rep2 = 6
        self.panel = 'C'
        self.markers = ["pAMPK_new_cy3", "DAPI_new_cy3"]
...
class Config_D(Config_Base_4Markers):
    def __init__(self, batch, plate):
        ...
        self.col_rep2 = 8
        self.panel = 'D'
        self.markers = ["Cas3_new_cy3", "DAPI_new_cy3"]

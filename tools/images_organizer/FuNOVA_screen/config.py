...
FUNOVA_SCREEN_DIR = "/home/projects/hornsteinlab/Collaboration/Guy_Lior"
class Config():
    def __init__(self):
        super().__init__()
        
        self.LOGGING_PATH = os.path.join(os.getenv("NOVA_LOCAL"), 'tools', 'images_organizer', 'FuNOVA_screen', 'logs', 'screen')
        ...
        self.SRC_ROOT_PATH = os.path.join(FUNOVA_SCREEN_DIR, "fuNOVA_Screen_B1","projected")

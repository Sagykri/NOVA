...
SRC_ROOT_PATH = "/home/projects/hornsteinlab/Collaboration/MOmaps/input/images/raw/SpinningDisk/NiemannPick_fix"

# Path to destination folder (root)
DST_ROOT_PATH = "/home/projects/hornsteinlab/Collaboration/MOmaps/input/images/raw/SpinningDisk/NiemannPick_sort"
...
CONFIG = {
    KEY_CELL_LINES: {
        "WT": {
            ...
            "HPBCD": [(201,300), (301,400)]
        },
        "KO": {
            "Untreated": [(401,500), (501, 600)],
            "HPBCD": [(601,700), (701, 800)]}
    },
    KEY_MARKERS_ALIAS_ORDERED: ["mCherry", "Cy5", "GFP", "DAPI"],
    KEY_MARKERS: {
        ...
        "panelK": ["PML", "mitotracker", "PEX14", "DAPI"],
        },
        KEY_REPS: ["rep1", "rep2"],
        KEY_COL_WELLS: {
            "2": ['WT','Untreated'],

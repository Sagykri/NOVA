...
import pandas as pd
import numpy as np
from config import DST_ROOT_PATH, SRC_ROOT_PATH, CUT_FILES
...
def main():
    ...
    for folder in folders:
        # Init
        folder_path, batch, panel = init_folders(folder)
        
        # Copy files to dist
        n_copied += copy_files(folder_path, panel, batch, cut_files=CUT_FILES)

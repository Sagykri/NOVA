...
new_d8_marker_info = pd.DataFrame([[['Cy5']]*12 + [['mCherry']]*12 + [['GFP']]*5,
                         ...
                         columns = ['G3BP1','NONO','SQSTM1','PSD95','NEMO','GM130','NCL', 
                                    ...
                                    'PURA','CD41','Tubulin', 'Phalloidin', 'TOMM20']).T  # order here is important!
...
NIH_d8_cell_lines = ['FUSHomozygous', 'WT', 'FUSRevertant', 'FUSHeterozygous']

NIH_d8_cell_lines_to_cond = {'FUSHomozygous':['Untreated'], 
                             'WT':['Untreated','stress'], 
                             'FUSRevertant':['Untreated'],
                             'FUSHeterozygous':['Untreated']}

NIH_d8_cell_lines_for_disp = {'FUSHomozygous_Untreated':'FUSHomozygous', 
                              'WT_stress':'WT stress', 
                              'WT_Untreated':'WT Untreated',
                              'FUSRevertant_Untreated':'FUSRevertant',
                              'FUSHeterozygous_Untreated':'FUSHeterozygous'}
...
NIH_d8_line_colors = {
    'FUSHeterozygous Untreated': NIH_d8_colorblind_palette[0],
    'FUSHomozygous Untreated': NIH_d8_colorblind_palette[1],
    'FUSRevertant Untreated': NIH_d8_colorblind_palette[2],
...
# ----------------------------------------- #
# regular neurons FUS pertubations (DRUG SCREEN)
# ----------------------------------------- #
...
# ----------------------------------------- #
# SPD 18 days
spd18days_panels = pd.DataFrame( [['PURA','CD41','Phalloidin',np.nan, np.nan, np.nan, np.nan, np.nan, np.nan,
                                   'Tubulin', np.nan, 'PEX14'],
                                  ['TOMM20','TDP43','FMRP', 'CLTC', 'DCP1A', 'KIF5A', 'NCL','ANXA11', 
                                   'Calreticulin',     'PSPC1',  'VDAC1', 'PML'],
                                  ['G3BP1','AGO2','SQSTM1',   'PSD95',    'NEMO', 'GM130', 'FUS', 'SNCA',   
                                   'LAMP1', 'HNRNPA1',  'NONO', 'mitotracker'],['DAPI']*12],
                                  columns=['A','B','C','D','E','F','G','H','I','J', 'K', 'L'],
...
spd18days_marker_info = pd.DataFrame([[['GFP']]*5 + [['mCherry']]*12 + [['Cy5']]*12,
                         ...
                         columns = ['PURA','CD41','Phalloidin','Tubulin','PEX14',
                                    'TOMM20','TDP43','FMRP', 'CLTC', 'DCP1A', 'KIF5A', 
                                    'NCL','ANXA11', 'Calreticulin',     'PSPC1',  'VDAC1', 
                                    'PML','G3BP1','AGO2','SQSTM1',   'PSD95',    'NEMO', 
                                    'GM130', 'FUS', 'SNCA',   'LAMP1',  'HNRNPA1',  'NONO', 'mitotracker']).T  #order here is important - 

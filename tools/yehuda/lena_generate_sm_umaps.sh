...
echo "Running script"
$MOMAPS_HOME/bash_commands/run_py.sh $MOMAPS_HOME/src/runables/run_synthetic_multiplexing -g -m 15000 -b 10 -a ./tools/yehuda/lena_model_config/NeuroselfLenaConfig ./tools/yehuda/lena_dataset_config/LenaDatasetConfig /home/labs/hornsteinlab/Collaboration/MOmaps/tools/yehuda -q gpu-short

...
class LenaDatasetConfig(DatasetConfig):
    def __init__(self):
        ...
        input_folders_names = ['batch3_16bit_no_downsample', 'batch4_16bit_no_downsample', 'batch5_16bit_no_downsample']
        ...
        self.SPLIT_DATA = False # True #split data - if we run batch 7 or 8 we need to put here True because it should run only on the test set. 

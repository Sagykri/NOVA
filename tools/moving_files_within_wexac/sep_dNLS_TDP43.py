...
for batch in batches:
    batch_dir = os.path.join('/home','projects','hornsteinlab','Collaboration','MOmaps','input','images',
...
#                 path = os.path.join('/home','projects','hornsteinlab','Collaboration','MOmaps_Sagy','MOmaps',

...
1 - load configs
2 - load model
3 - get attn matrix from model (generate using infernce)
4 - process attn matrix (process attn maps)
5 - plot - create figs
...
def generate_attn_maps_with_model(outputs_folder_path:str, config_path_data:str, config_path_attn:str,config_path_plot:str, batch_size:int=10)->None:
    ...
    batch_size = min((len(dataset) // 3), 700)
    ...
    # sample some of the attn maps if exceed maximum
